...
- [ ] 4 FEB 2023 > I'm working on my last assignment and practice assessments this weekend, but every time, I look at question set, it seems a new bouncer on my head. It is a virtual world that I'm looking at and I have to take vendor certifications as well. Let's see, I'm trying to take it slow, but industry is moving at a fast pace and I definitely feel a cloud services deficit in real because of cloud native app development. My work is similar, I'm motivated to migrate on to the cloud, but still, this is not a easy topic. Hopefully, my deadline to scale up on the cloud will turn out alright & I would less FOMO.   
